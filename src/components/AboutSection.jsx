            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-26 items-center">
             ...
             bg-clip-text text-transparent dark:from-sky-300 dark:via-fuchsia-400 dark:to-pink-400">
                    ...
                    <p className="text-muted-foreground text-lg">
                        Over 13 months of self-directed study, I delivered 7 projects (2 full-stack) that translate client requirements into robust, scalable web applications with excellent performance and user experience.
                    </p>
